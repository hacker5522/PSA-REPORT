...
<!-- Hero Section -->
<div class="page-hero bg-image overlay-dark" style="background-image: url('<?php echo e(asset('frontend/assets/img/plumber.jpg')); ?>'); background-size: cover; background-position: center; height: 100vh; display: flex; align-items: center; justify-content: center;">
    <div class="hero-section text-center text-white">
        ...
        <a href="<?php echo e(route('contact')); ?>" class="btn btn-warning" style="background-color: #FFC107; border: none; padding: 10px 30px; font-size: 1rem; font-weight: 600; letter-spacing: 1px;">Get a Free Quote</a>
    </div>
</div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 py-3">
                ...
                <a href="<?php echo e(route('about')); ?>" class="btn btn-warning" style="background-color: #FFC107; border: none; padding: 10px 30px; font-size: 1rem; font-weight: 600; letter-spacing: 1px;">Learn More</a>
            </div>
            <div class="col-lg-6">
                <div class="img-place custom-img-1">
                    <img src="<?php echo e(asset('frontend/assets/img/plumber4.jpg')); ?>" alt="Plumber at Work" style="border-radius: 10px; width: 100%; height: auto;">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-4 py-2">
                <div class="card-service" style="background: #fff; border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); overflow: hidden; height:400px;">
                    <div class="header">
                        <img src="<?php echo e(asset('frontend/assets/img/plumber2.jpg')); ?>" alt="Leak Repairs" style="width: 100%; height: 200px; object-fit: cover;">
                    </div>
            ...
            <div class="col-lg-4 py-2">
                <div class="card-service" style="background: #fff; border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); overflow: hidden; height:400px;">
                    <div class="header">
                        <img src="<?php echo e(asset('frontend/assets/img/plumber4.jpg')); ?>" alt="Drain Cleaning" style="width: 100%; height: 200px; object-fit: cover;">
                    </div>
                    <div class="body" style="padding: 20px;">
            ...
            <div class="col-lg-4 py-2">
                <div class="card-service" style="background: #fff; border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); overflow: hidden; height:400px;">
                    <div class="header">
                        <img src="<?php echo e(asset('frontend/assets/img/plumber.jpg')); ?>" alt="Water Heater Installation" style="width: 100%; height: 200px; object-fit: cover;">
                    </div>
                    <div class="body" style="padding: 20px;">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 py-2">
                <div class="card-pricing" style="background: #fff; border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); padding: 30px; text-align: center; height:450px">
                    ...
                    <a href="<?php echo e(route('contact')); ?>" class="btn btn-warning" style="background-color: #FFC107; border: none; padding: 10px 30px; font-size: 1rem; font-weight: 600; letter-spacing: 1px;">Get Started</a>
                </div>
            </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\plumbing\resources\views/welcome.blade.php ENDPATH**/ ?>